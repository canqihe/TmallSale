...
public class ApiTest {
    ...
    public static final String serverUrl = GlobalUrl.BASE_URL;
    public static final String appKey = GlobalUrl.TAOBAO_APP_KEY; // 可替换为您的沙箱环境应用的appKey
    public static final String appSecret = GlobalUrl.TAOBAO_APP_SECRET; // 可替换为您的沙箱环境应用的appSecret
    public static final String sessionKey = "test"; // 必须替换为沙箱账号授权得到的真实有效sessionKey
